...
> **版本**：v1.3.9 | **适用对象**：效贷测试专家管理员 | **更新日期**：2026-07-23
...
> `defaultInitPrompt` 是用户点击「立即使用」后预填在输入框中的文本。v1.3.7 起改为完整的专家能力介绍 + 身份验证引导，而非直接跳到"整理文档"。
