...
4. 通知新人员按以下步骤安装：
   ...
   - **运行注册脚本**：从 https://github.com/hansonzhang0606-ux/xiaodai-test-expert/tree/main/scripts 下载 `register_expert.bat` 和 `register_expert.ps1`，双击 `register_expert.bat` 运行
...
| 版本 | 日期 | 主要变更 |
|------|------|---------|
| v1.3.6 | 2026-07-22 | 新增安装后注册脚本（register_expert），解决团队市场安装后专家不显示的问题 |
